...
abstract class AbstractUnitTest<T : Activity>(clazz: Class<T>) {
    ...
    fun SeekBar.setProgressAsUser(progress: Int) {
        ...
        var clazz: Class<*> = this::class.java  // may be a subclass of SeekBar
     ...
     * @param expectedRequestCode requestCode that test expects implementation to use in their code
     ...
     *
     *  Asserts that the size of the list is at least itemIndex + 1.
     *
